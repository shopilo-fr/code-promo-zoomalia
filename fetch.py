...
Sursa: https://shopilo.fr/reductions/zoomalia.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/zoomalia.com"
STORE_NAME = "Zoomalia"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Zoomalia depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-zoomalia)"
    }
    try:
